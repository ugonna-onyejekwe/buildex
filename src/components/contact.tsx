...
export const ContactUs = () => {
  return (
    <section className="bg-background_alt mt-[100px] py-[100px] max-[900px]:mt-[50px]">
      <div className="container ">
        <h2>Looking for service? See how easy it is with us</h2>
        ...
        <div className=" flex items-center max-[900px]:flex-col mt-[50px] max-[900px]:mt-[30px] gap-[30px]">
          ...
          <div className="bg-background flex-[0.8] p-[30px] rounded-md shadow-md">
